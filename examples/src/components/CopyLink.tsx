...
export default function CopyLink() {
  ...
  return (
    <div className="mr-2 mb-2 text-left items-center text-neutral-500 border-2 border-yellow-200 rounded-lg bg-yellow-50 p-6 ">
      ...
      <span className="pr-2">
        To simulate another user appearing on this document, copy the link to this document and open
        it in a new window. When you interact on one screen, you should see the user action happens
        on another.
      </span>
      <button
